...
aux << (DressStatus.find_by_name("Vendido por Proveedor") || DressStatus.create(:name => 'Vendido por Proveedor', :description => 'El proveedor vendió el vestido y nos notificó para que lo saquemos de la página. No aparece en la página.'))
aux.each { |x| puts x.name}
puts "\n"
